...
# if you haven't defined "DOCUMENT_ROOT" variable, change this line to something like following commented line
#define('SITEMESH_DOCUMENT_ROOT', 'C:/Program Files (x86)/Apache Software Foundation/Apache2.2/htdocs/sitemeshexmpl');
